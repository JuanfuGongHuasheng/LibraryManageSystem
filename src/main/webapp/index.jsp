            ...
            <div class="container">
                ...
                <div class="col-md-7 about-left-grid">
                    <div class="inner-about2">
                        <h4>the splendid Central Library</h4><br>
                        <h5>the library catalogue</h5>
                        <ul class="about-list">
                            <li>
                                <i class="fa fa-play-circle-o" aria-hidden="true"></i>Ebooks</li>
                            <li>
                                <i class="fa fa-play-circle-o" aria-hidden="true"></i>Maganize</li>
                            <li>
                                <i class="fa fa-play-circle-o" aria-hidden="true"></i>Newspaper</li>
                            <li>
                                <i class="fa fa-play-circle-o" aria-hidden="true"></i>CD</li>
                        </ul>
                    </div>

                    <!-- about left bottom - services -->
                    <div class="principles-grids principles-grids1" style="margin-top: 40px">
                        <div class="inner-about2">
                            <h4>the splendid Central Library</h4><br>
                            <h5>the job catalogue</h5>
                            <ul class="about-list">
                                <li>
                                    <i class="fa fa-play-circle-o" aria-hidden="true"></i>Leaders</li>
                                <li>
                                    <i class="fa fa-play-circle-o" aria-hidden="true"></i>Students</li>
                                <li>
                                    <i class="fa fa-play-circle-o" aria-hidden="true"></i>Teachers</li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-md-6 about-bottom-right">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-6 services-w3ls">
                        <div class="ab1">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-9 ab1-text">
                                <h5>e-books</h5>
                                <p>E-book refers to a handheld reader that integrates the storage and display terminal of digital text, picture, sound, image and so on.</p>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="ab1">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-9 ab1-text">
                                <h5>magazines</h5>
                                <p>A printed book with a fixed title and periodic or irregular continuous publication in order of time, volume, number, or year or month.</p>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
                    <div class="col-md-6 col-sm-6 col-xs-6 services-w3ls service2">
                        <div class="ab1">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-9 ab1-text">
                                <h5>Newspaper</h5>
                                <p>Newspapers are printed publications that are regularly issued to the public, mainly based on news and current events.</p>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                        <div class="ab1">
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-9 ab1-text">
                                <h5>CD</h5>
                                <p>Optical disc is a kind of object that uses optical information as storage carrier and used to store data.</p>
                            </div>
                            <div class="clearfix"></div>
                        </div>
                    </div>
